...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel99.setText("Enter Line Number To Delete :");

        status.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        status.setToolTipText("");
        status.setPreferredSize(new java.awt.Dimension(5, 28));
        ...
        lineNumberTextField.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        deleteOne.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        deleteOne.setForeground(new java.awt.Color(0, 153, 153));
        ...
        deleteAll.setForeground(new java.awt.Color(0, 153, 153));
